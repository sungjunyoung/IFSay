...
public class SplashActivity extends Activity {
    ...
    private void dataInit() {
        ...
        Question question1 = new Question(0,"어린 시절에서, 단 하나만 바꿀 수 있다면, 무엇을 바꾸겠어요?",new Date(2016,4,28));
        Question question2 = new Question(1,"어제 봤는데, 오늘도 보고싶고, 내일도 보고싶은 인생의 영화는 무엇이었나요?",new Date(2016,4,19));
        Question question3 = new Question(2,"당신의 자서전 첫 문장은 어떻게 시작할까요?",new Date(2016,4,20));
        Question question4 = new Question(3,"오늘 10억원이 생겼습니다. 당신은 무엇을 할까요?",new Date(2016,4,21));
        Question question5 = new Question(4,"입원하기 직전으로 돌아간다면, 나는 무엇을 할까요?",new Date(2016,4,22));
        ...
        Comment comment1 = new Comment(0,2,"저도 비긴어게인 정말 좋아하는데","병훈",new Date(2016,4,19));
        Comment comment2 = new Comment(1,4,"저도 지긋지긋한 휠체어 벗어나고 싶어요!","은범",new Date(2016,4,20));
        Comment comment3 = new Comment(2,6,"맞아요.. 운동 안한건 정말 후회되어요. 엄마랑 산책이라도 많이 갈껄...\n","결",new Date(2016,4,22));
        Comment comment4 = new Comment(3,6,"222 운동의 중요성은 정말.. 퇴원하면 누구보다 열심히 몸 관리할거에요","준영",new Date(2016,4,22));
        Comment comment5 = new Comment(4,6,"저도 조기축구회 회원비만 얼마 냈는지.. 돌아가면 꼭 갈거에요","다영",new Date(2016,4,22));
        Comment comment6 = new Comment(5,7,"와...! 진짜 멋있는 생각이에요 그 꿈 꼭 이루길 바랄게요!! ","예진",new Date(2016,4,22));
        Comment comment7 = new Comment(6,7,"오오 나중에 유명한 소설 쓰면 꼭 서울의료원에서 구상했다고 밝히셔야해요 ㅎㅎ","은범",new Date(2016,4,22));
        Comment comment8 = new Comment(7,7,"기대합니다!! 요즘은 어떤 것 읽으세요? 재미있는 책 추천해주세요! 너무 심심해요","결",new Date(2016,4,22));
        Comment comment9 = new Comment(8,7,"지금도 쓰고 계셔요? 분명히 좋은 글일거에요 :) 괜찮으시면 공유해주세요. 읽어보고싶어요.","준영",new Date(2016,4,22));
        Comment comment10 = new Comment(9,8,"영업왕이 목표라니! 너무 멋진 남편감이에요!! (신부감일수도!!)","예진",new Date(2016,4,22));
        Comment comment11 = new Comment(10,8,"자기 일에 자부심을 갖는 모습 너무 좋은것 같아요. 퇴원하고 꼭 해내실수 있을거에요 응원합니다!","예진",new Date(2016,4,22));
